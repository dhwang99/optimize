...
class Simplex:
    ...
    def solve(self):
        ...
        while theta.min() < 0:
            ...
            B[row-1] = col
            pdb.set_trace()
            theta[1:] = self.mat[0,1:] - np.dot(self.mat[0,:].take(B), self.mat[1:, 1:]) # theta = C - (Cb.T * B.inv * A) = C - Cb.T * A

        pdb.set_trace()
        
        z = np.dot(self.mat[0].take(B) * self.mat[1:, 0])
...
if __name__ == "__main__":
    ...
    print "expect result -24; real result:", result
